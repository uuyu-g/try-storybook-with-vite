import type { StoryObj, ReactRenderer } from '@storybook/react';
...
// ____________________________________________________________
//
type Context = PlayFunctionContext<ReactRenderer, unknown>;
const fillAndSubmit = (inlinePlay?: (ctx: Context) => Promise<void>) => async (ctx: Context) => {
